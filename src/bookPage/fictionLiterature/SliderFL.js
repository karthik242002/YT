...
import Container from '../fictionLiterature/ContainerFL';

const SliderFL = () => {
  const [cart, setCart] = useState([]);
  const [currentIndex, setCurrentIndex] = useState(0);
  const containerChunkSize = 3;
